...
public class TextFileTest {
    public static void main(String[] args) throws IOException
    {
        ...
        try (var out = new PrintWriter("ch02/textFile/employee.dat", StandardCharsets.UTF_8))
        {
            writeData(staff, out);
        }

        try (var in = new Scanner(new FileInputStream("ch02/textFile/employee.dat"), "UTF-8"))
        {
